...
// public: rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr left_cmd, right_cmd, m0r_cmd, m0l_cmd, m1r_cmd, m1l_cmd;
...
public:
	...
	rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr left_cmd, right_cmd, m0r_cmd, m0l_cmd, m1r_cmd, m1l_cmd;
	double LIM_, smooth_x_vel;
	lin_x_cmd, ang_z_cmd, integral, Kp, Kd, Ki, vel_int, height_cmd, roll_cmd, JUMP_hstar;
	...
	void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
	{
		...
		velocity_cmd = nh->create_subscription<geometry_msgs::msg::Twist>(vel_topic, 1, std::bind(&DiabloControlPlugin::vel_cmd_callback, this, _1));
		...
		left_cmd = nh->create_publisher<geometry_msgs::msg::Twist><std_msgs::Float64>(ns+"/Motor2_L/vel_cmd", 1); 			
		right_cmd = nh->create_publisher<geometry_msgs::msg::Twist><std_msgs::Float64>(ns+"/Motor2_R/vel_cmd", 1); 			
		m0r_cmd = nh->create_publisher<geometry_msgs::msg::Twist><std_msgs::Float64>(ns+"/Motor0_R/pos_cmd", 1); 			
		m0l_cmd = nh->create_publisher<geometry_msgs::msg::Twist><std_msgs::Float64>(ns+"/Motor0_L/pos_cmd", 1); 					
		m1r_cmd = nh->create_publisher<geometry_msgs::msg::Twist><std_msgs::Float64>(ns+"/Motor1_R/pos_cmd", 1); 			
		m1l_cmd = nh->create_publisher<geometry_msgs::msg::Twist><std_msgs::Float64>(ns+"/Motor1_L/pos_cmd", 1);		
